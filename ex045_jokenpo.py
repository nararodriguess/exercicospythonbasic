...
# condição caso os objetos forem diferentes
    ...
    if jogador =='tesoura':
        if computador == 'pedra':
            ...
            print(f'Você venceu! Eu escolhi {computador} e você escolheu {jogador}')
    elif jogador == 'pedra':
        if computador == 'tesoura':
            print(f'Você venceu! Eu escolhi {computador} e você escolher {jogador}')
        elif computador == 'papel':
            print(f'Você perdeu! Eu escolhi {computador} e você escolheu {jogador}')
    elif jogador == 'papel':
        if computador == 'pedra':
            print(f'Você venceu! Eu escolhi {computador} e você escolhei {jogador}')
